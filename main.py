...
btn_divide = ctk.CTkButton(btn_menu, text="/", width=60, height=60, hover = False, cursor="hand2", fg_color='#F18F01', font=button_font
...
btn_minus = ctk.CTkButton(btn_menu, text="-", width=60, height=60, hover = False, cursor="hand2", fg_color='#F18F01', font=button_font
, command = minusButton ) 
btn_plus = ctk.CTkButton(btn_menu, text="+", width=60, height=60, hover = False, cursor="hand2", fg_color='#F18F01', font=button_font
, command = plusButton ) 
btn_multiply = ctk.CTkButton(btn_menu, text="x", width=60, height=60, hover = False, cursor="hand2", fg_color='#F18F01', font=button_font
, command = multiplyButton )
btn_equals = ctk.CTkButton(btn_menu, text="=", width=60, height=60, hover = False, cursor="hand2", fg_color='#F18F01', font=button_font
, command = equalButton ) 
